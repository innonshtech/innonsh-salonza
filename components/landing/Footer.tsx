...
export default function Footer() {
  ...
  return (
    <footer className="bg-slate-900 text-slate-300 relative overflow-hidden p-10">
      ...
      <div className="container-custom mx-auto px-6 py-16 relative z-10">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 bg-slate-800 rounded-lg flex items-center justify-center hover:bg-purple-600 transition-colors">
